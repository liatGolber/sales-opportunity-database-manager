            ...
            try
            {
                ...
                foreach (Package p in packages.ToList())
                {
                    if (p.ID == id)
                    {
                        ...
                        (ess["Sheet"] as Excel.Worksheet).Cells[i, 4] = DateTime.Now.Date;
                        (ess["Sheet"] as Excel.Worksheet).Cells[i, 5] = DateTime.Now.Date.AddMonths(12);
        ...
        public static void UpdatePacList()
        {
            ...
            try
            {
                ...
                for (int i = 1; i <= values.GetLength(0); i++)
                {
                    ...
                    ret.lineNum = values[i, 2].ToString();
                    ret.packageType = Convert.ToInt32(values[i, 3].ToString());
                    ret.startD = DateTime.FromOADate((int)values[i, 4]);
                    ret.endD = DateTime.FromOADate((int)values[i, 5]);
